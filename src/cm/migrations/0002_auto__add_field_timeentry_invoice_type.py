...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeEntry.invoice_type'
        db.add_column('cm_timeentry', 'invoice_type',
                      self.gf('django.db.models.fields.CharField')(default='invoice', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimeEntry.invoice_type'
        db.delete_column('cm_timeentry', 'invoice_type')
