...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TimeEntry.invoice_line_item'
        db.add_column('timetracking_timeentry', 'invoice_line_item',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TimeEntry.invoice_line_item'
        db.delete_column('timetracking_timeentry', 'invoice_line_item_id')
    ...
    models = {
        ...
        'timetracking.timeentry': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_line_item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['invoicing.InvoiceLineItem']", 'null': 'True', 'blank': 'True'}),
